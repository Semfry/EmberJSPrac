...
define("shaun-site/tests/integration/components/pageheader-test", ["@ember/template-factory", "qunit", "shaun-site/tests/helpers", "@ember/test-helpers"], function (_templateFactory, _qunit, _helpers, _testHelpers) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"qunit",0,"shaun-site/tests/helpers",0,"@ember/test-helpers",0,"ember-cli-htmlbars"eaimeta@70e063a35619d71f

  (0, _qunit.module)('Integration | Component | pageheader', function (hooks) {
    (0, _helpers.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      ...
      */
      {
        "id": "v+LGVm9H",
        "block": "[[[8,[39,0],null,null,null]],[],false,[\"pageheader\"]]",
        "moduleName": "(unknown template module)",
        "isStrictMode": false
      }));
